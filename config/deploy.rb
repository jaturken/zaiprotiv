...
set :deploy_to, '/home/zaiprotiv'
set :repository, 'https://github.com/jaturken/zaiprotiv'
set :branch, 'master'

# Manually create these paths in shared/ (eg: shared/config/database.yml) in your server.
# They will be linked in the 'deploy:link_shared_paths' step.
set :shared_paths, ['config/database.yml', 'config/secrets.yml', 'log', 'tmp', 'db/sphinx']
