...
ActiveRecord::Schema.define(version: 20161112143420) do
  ...
  create_table "sample_arguments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci" do |t|
    t.integer  "sample_id"
